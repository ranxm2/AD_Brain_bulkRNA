...
```{r load_bulkRNA_data}
sample_df <- read.csv(here::here("data", "bulkRNA", 
                                 "sample_info_AD.csv"), header = TRUE)


sample_list <- sample_df$Sample.name
sample_list <- gsub("_", "-", sample_list)
condition_list <-  sample_df$Diagosis
counts_ref <- read.csv(here::here("data", "bulkRNA",
                                  "raw","WT-V-1_final_gene_with_names.csv"), 
                       header = TRUE)

counts <- tibble()
for (i in 1:length(sample_list)) {
  sample <- sample_list[i]
  gene_file <- here::here("data", "bulkRNA","raw",
...
write.csv(counts,here::here("data", "bulkRNA", 
...
write.csv(aggregated_data, here::here("data", "bulkRNA", 
