...
subtitle: " CTRL Condition: Vehicle 100 vs 10"
author: "Ximing Ran"
date: "2025-03-24"
output:
  pdf_document:
...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/02-DEG-CTRL_10_vs_100/Analysis_figure/"
)
...
result_folder_all = './results/02-DEG-CTRL_10_vs_100'
result_folder = result_folder_all
Result_folder_structure(result_folder)

# load the comparison group information
reference_group <- "CTRL_Veh_10"
compare_group <- "CTRL_Veh_100"
reference_group_short <- "CTRL_10"
compare_group_short <- "Veh_100"
