...
knitr::opts_chunk$set(
  ...
  warning = FALSE,
  message = FALSE,
  fig.path = "./results/05-GSVA-4-group-select/Analysis_figure/"
)
...
# pathway_list <- rownames(gsva_matrix)
# filter it contain the immune inflame, synap, mitocho, amyloid
pathway_list <- pathway_list[grep("COMPLEMENT", pathway_list, ignore.case = TRUE)]
...
for (i in 1:length(pathway_list)){
  ...
  p<-plot_gsva_boxplot_mutil_4(gsva_matrix,
                    condition_list_label =condition_list_label,
                    pathway_name =  pathway_name,
                    figure_folder = file.path(result_folder,"05-GSVA-4-group-select","Boxplot-COMPLEMENT"),
                    file_name = paste0("GSVA_", pathway_name),
                    fig.height = 6, fig.width = 4, save=TRUE,
                    reference_group_1="CTRL_Veh" , compare_group_1="CTRL_10",
                    reference_group_2="AD_Veh"   , compare_group_2="AD_10",
...
pathway_list <- rownames(gsva_matrix)
# filter it contain the immune inflame, synap, mitocho, amyloid
pathway_list <- pathway_list[grep("lopid|cytokine|phagocytosis", pathway_list, ignore.case = TRUE)]
...
for (i in 1:length(pathway_list)){
  ...
  p<-plot_gsva_boxplot_mutil_4(gsva_matrix,
                    condition_list_label =condition_list_label,
                    pathway_name =  pathway_name,
                    figure_folder = file.path(result_folder,"05-GSVA-4-group-select","Boxplot-new"),
                    file_name = paste0("GSVA_", pathway_name),
                    fig.height = 6, fig.width = 4, save=TRUE,
                    reference_group_1="CTRL_Veh" , compare_group_1="CTRL_10",
                    reference_group_2="AD_Veh"   , compare_group_2="AD_10",
